...
function CardInfo() {
	return (
		<>
			...
			<div>
				<p>
					mapa (precisamos de latitude e longitude para marcar cada um dos 5 pontos de atração) <img src='https://www.oficinadanet.com.br/media/post/27852/750/adicionar-parada.jpg' alt='mapa' />
				</p>
				<section>
					<div>
						<p>
