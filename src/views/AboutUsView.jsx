				...
				<div className='aboutUsContainer'>
					...
					<div className='companyContainer'>
						...
						<p>
							We are our Logo ! <br />
							<br />
							We are the freshness of the landscapes of the Marão Mountain and the history of the Aboboreira Mountain. <br />
							<br />
							We are the essence of our Vinho Verde <br />
							We are the traditions of our gastronomy and conventual pastry <br />
							<br />
							We are the history of the St. Gonçalo Bridge <br />
							<br />
